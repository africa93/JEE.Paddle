...
public class TrainingResource {
	...
	public List<TrainingWrapper> showTrainings(@AuthenticationPrincipal User player){
		return trainingController.showTrainings();
	}

	@RequestMapping(value= Uris.REGISTER_TRAINING + Uris.ID, method = RequestMethod.POST)
	public void registerTraining(@AuthenticationPrincipal User player, @PathVariable int trainingID, @RequestBody String pupilUsername)
